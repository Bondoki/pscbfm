#ifndef FEATURE_NETWORK_H
#define FEATURE_NETWORK_H
 ...
 * 		  indicating if monomer has type NONE(0), HEPARIN(1), STARPEG(2), or CROSSLINKER(3)
 *
 **/
class NetworkTypeTag
{
public:
	...
	NETWORK_TYPE_TAG getNetworkTypeTag() const {
			return Tag;
		}
	 ...
	 * @param attr
	 */
	void setNetworkTypeTag(NETWORK_TYPE_TAG _NetworkTypeTag){ this->Tag=_NetworkTypeTag;}
